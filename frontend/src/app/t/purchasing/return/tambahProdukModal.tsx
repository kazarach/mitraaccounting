...
const TambahProdukModalret: React.FC<TambahProdukModalProps> = ({ tableName }) => {
  ...
  const handleAddProduct = (product: any) => {
    ...
    const newItem = {
      ...
      jumlah_pesanan: 0,
      quantity: 0,
      returnQty: product.jumlah_barang ?? 1,
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center border rounded">
                <input
                  ...
                  className="w-10 h-8 bg-gray-100 text-center   [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                  min={0}
                />
              </div>
              <Button
...
export default TambahProdukModalret;
