...
import { CustomerDropdown2 } from '../transaction/customer-dd2';
...
const TpModalReturnSelling: React.FC<TpModalReturnSellingProps> = ({ onCustomerSelect }) => {
  ...
  const { data, error, isLoading } = useSWR(
    ...
    () => {
      ...
      return fetcher(`/api/proxy/api/transactions/?th_type=SALE&th_order=false&th_return=false${startParam}${endParam}${supplierParam}${operatorParam}`);
    }
  );
