...
const SellingReturnArchive = () => {
  ...
  const queryParams = useMemo(() => {
    let params = `th_type=10&th_status=true&th_order=false`;
                  ...
                  {isLoading ? (
                    ...
                    table.getRowModel().rows.map((row, rowIndex) => (
                      <TableRow
                        ...
                        className={cn(
                          "p-2 border-b border-r cursor-pointer last:border-r-0 overflow-hidden whitespace-nowrap text-ellipsis",
