...
from ..models import TransactionHistory, TransItemDetail, Supplier, TransactionType
...
class TransactionHistoryFilter(django_filters.FilterSet):
    ...
    th_type = django_filters.ModelMultipleChoiceFilter(
        queryset=TransactionType.objects.all(),
        field_name="th_type__id",  # assuming `th_type` is ManyToMany to `TransactionTag`
        to_field_name="id",
        conjoined=False
    )
