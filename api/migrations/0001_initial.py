# Generated by Django 5.1.7 on 2025-03-22 08:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ed_type', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superuser', 'Superuser'), ('master', 'Master'), ('admin', 'Admin'), ('staff', 'Staff'), ('member', 'Member'), ('user', 'User')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('edi_disc', models.DecimalField(decimal_places=2, max_digits=10)),
                ...
                ('edi_type', models.CharField(blank=True, max_length=50, null=True)),
