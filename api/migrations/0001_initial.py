    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stocks', to='api.unit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('th_type', models.CharField(choices=[('SALE', 'Sale'), ('PURCHASE', 'Purchase'), ('RETURN_SALE', 'Sales Return'), ('RETURN_PURCHASE', 'Purchase Return'), ('USAGE', 'Internal Usage'), ('TRANSFER', 'Transfer'), ('PAYMENT', 'Payment'), ('RECEIPT', 'Receipt'), ('ADJUSTMENT', 'Adjustment'), ('EXPENSE', 'Expense'), ('ORDERIN', 'Order In'), ('ORDEROUT', 'Order Out')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='arap', to='api.transactionhistory')),
            ],
            options={
                'verbose_name': 'ARAP',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disc', models.DecimalField(decimal_places=2, default=0, max_digits=15)),
